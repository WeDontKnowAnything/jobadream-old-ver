...
본 프로젝트는 **대기업, 중견기업, 강소기업 뿐 아니라 비재무 데이터를 활용한 중소기업 및 스타트업의 휴폐업을 예측하는 모델을 개발**하여, 이를 기반으로 **구직자가 신뢰성 있는 기업 안정성 평가 정보를 제공받을 수 있는 채용 정보 제공 사이트를 구축**하고자 한다.   
<br />
...
## 📌 프로젝트 주요 기능
### 1. 기업 안정성 평가 정보 제공
### 2. 기업에 대한 채용 공고 플랫폼 링크 조회 시각화
### 3. 기업/채용 공고 조회 검색 및 필터 기능   
<br /><br /><br />
...
- [ ] 거시 경제 지표 및 금융시장 지표 데이터
  - 한국은행, 통계청 등 주요 기관에서 집계 및 발표한 거시 경제 지표 및 금융시장 지표 데이터 수집 및 전처리 진행 중
- [ ] 연봉 정보 데이터
...
- **jobs**
    - 채용 공고 sample data
    - 채용 공고 ID, 기업명, 공고 제목, 근무지, 요구 경력, 모집 시작 날짜, 모집 마감 날짜 등
- **job_url**
    - 채용 공고 연결 url
    - 제공 플랫폼명, url, 채용 공고 ID
- **post**
    - 게시글
    - 제목, 본문, 작성일
- **comment**
